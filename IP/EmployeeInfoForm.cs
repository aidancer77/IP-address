...
namespace IP
{
    public partial class EmployeeInfoForm : Form
    {
        ...
        private void EmployeeInfoForm_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Данные сотрудника не загружены", "Внимание", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private async void TimerTickHandler(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(checkLineJSON))
            {
                ...
                MessageBox.Show("Линия не запущена. Повторите авторизацию", "Внимание", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
